...
* Who            When           Ref            What            
* -------------------------------------------------------------
* Mark Collier   13/04/2025     trans          Transaction__c 
* -------------------------------------------------------------
**/
trigger Trig_Transaction on Transaction__c (after delete, after insert, after undelete, after update, before insert, before update) {
